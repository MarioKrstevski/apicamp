...
/** Delete existing admin-owned rows for a table+locale before re-seeding. */
async function cleanTable(table: string, locale: string, adminId: string) {
  const { error, count } = await supabase
    .from(table)
    .delete({ count: "exact" })
    .eq("user_id", adminId)
  if (error) console.error(`  ✗ cleanup ${table}/${locale}:`, error.message)
  else if (count && count > 0) console.log(`  ↻ ${table}/${locale}: removed ${count} old rows`)
}

async function seedTable(table: string, locale: string, adminId: string, rows: object[]) {
  await cleanTable(table, locale, adminId)
...
// ─── ANIMALS ─────────────────────────────────────────────────────────────────
// locale: true — each locale seeds regionally relevant animals.
// For now, all locales share the same base catalog. Add locale-specific animals later.
...
const animals: Record<string, object[]> = {
  ...
  fr: [
    { name: "Hérisson d'Europe", scientificName: "Erinaceus europaeus", type: "mammal", habitat: "forest", diet: "omnivore", conservationStatus: "LC", weightKg: 1.2, lifespanYears: 7, isNocturnal: true, nativeRegion: "Western Europe", funFact: "Les hérissons peuvent avoir jusqu'à 8 000 épines et sont immunisés contre certains venins de serpent.", tags: ["nocturne", "jardins"] },
    { name: "Renard roux", scientificName: "Vulpes vulpes", type: "mammal", habitat: "forest", diet: "omnivore", conservationStatus: "LC", weightKg: 6, lifespanYears: 5, isNocturnal: true, nativeRegion: "Europe, Asia, North America", funFact: "Le renard roux utilise le champ magnétique terrestre pour chasser sous la neige.", speed: 50, tags: ["adaptable", "rusé"] },
    { name: "Lynx boréal", scientificName: "Lynx lynx", type: "mammal", habitat: "forest", diet: "carnivore", conservationStatus: "LC", weightKg: 25, lifespanYears: 17, isNocturnal: true, nativeRegion: "Europe, Sibérie", funFact: "Le lynx boréal a été réintroduit dans les Vosges et le Jura après son extinction en France.", speed: 60, tags: ["félin", "discret"] },
    { name: "Cigogne blanche", scientificName: "Ciconia ciconia", type: "bird", habitat: "wetland", diet: "carnivore", conservationStatus: "LC", weightKg: 3.5, lifespanYears: 25, isNocturnal: false, nativeRegion: "Europe, Afrique du Nord", funFact: "La cigogne blanche migre jusqu'à 20 000 km par an entre l'Europe et l'Afrique.", speed: 45, tags: ["migration", "Alsace"] },
    { name: "Chamois", scientificName: "Rupicapra rupicapra", type: "mammal", habitat: "mountain", diet: "herbivore", conservationStatus: "LC", weightKg: 40, lifespanYears: 22, isNocturnal: false, nativeRegion: "Alpes, Pyrénées", funFact: "Le chamois peut bondir jusqu'à 6 mètres de longueur et gravir des pentes de 60 degrés.", speed: 50, tags: ["montagne", "agile"] },
    { name: "Bison d'Europe", scientificName: "Bison bonasus", type: "mammal", habitat: "forest", diet: "herbivore", conservationStatus: "VU", weightKg: 800, lifespanYears: 25, isNocturnal: false, nativeRegion: "Europe de l'Est", funFact: "Le bison d'Europe a failli disparaître au XXe siècle — il n'en restait que 54 en captivité en 1927.", tags: ["mégafaune", "conservation"] },
    { name: "Macareux moine", scientificName: "Fratercula arctica", type: "bird", habitat: "ocean", diet: "piscivore", conservationStatus: "VU", weightKg: 0.5, lifespanYears: 30, isNocturnal: false, nativeRegion: "Atlantique Nord", funFact: "Le macareux moine peut transporter jusqu'à 60 petits poissons dans son bec à la fois.", speed: 88, tags: ["marin", "coloré"] },
    { name: "Martin-pêcheur", scientificName: "Alcedo atthis", type: "bird", habitat: "freshwater", diet: "piscivore", conservationStatus: "LC", weightKg: 0.04, lifespanYears: 7, isNocturnal: false, nativeRegion: "Europe, Asie, Afrique du Nord", funFact: "Le martin-pêcheur plonge à plus de 25 km/h et sa forme a inspiré le design du Shinkansen japonais.", speed: 40, tags: ["coloré", "plongeur"] },
    { name: "Castor d'Europe", scientificName: "Castor fiber", type: "mammal", habitat: "freshwater", diet: "herbivore", conservationStatus: "LC", weightKg: 25, lifespanYears: 15, isNocturnal: true, nativeRegion: "Europe", funFact: "Le castor d'Europe construit des barrages qui peuvent atteindre 100 mètres de long.", tags: ["ingénieur", "aquatique"] },
    { name: "Marmotte alpine", scientificName: "Marmota marmota", type: "mammal", habitat: "mountain", diet: "herbivore", conservationStatus: "LC", weightKg: 5.5, lifespanYears: 18, isNocturnal: false, nativeRegion: "Alpes européennes", funFact: "La marmotte alpine hiberne 6 mois par an et son cri d'alarme peut être entendu à plus de 1 km.", tags: ["hibernation", "alpin"] },
    { name: "Phoque moine de Méditerranée", scientificName: "Monachus monachus", type: "mammal", habitat: "ocean", diet: "piscivore", conservationStatus: "EN", weightKg: 300, lifespanYears: 30, isNocturnal: false, nativeRegion: "Méditerranée", funFact: "Le phoque moine de Méditerranée est le phoque le plus menacé au monde — moins de 700 individus subsistent.", tags: ["menacé", "marin"] },
    { name: "Loutre d'Europe", scientificName: "Lutra lutra", type: "mammal", habitat: "freshwater", diet: "piscivore", conservationStatus: "NT", weightKg: 10, lifespanYears: 12, isNocturnal: true, nativeRegion: "Europe", funFact: "La loutre d'Europe peut rester en apnée jusqu'à 8 minutes et fermer ses narines sous l'eau.", speed: 12, tags: ["aquatique", "joueur"] },
    { name: "Chouette effraie", scientificName: "Tyto alba", type: "bird", habitat: "grassland", diet: "carnivore", conservationStatus: "LC", weightKg: 0.35, lifespanYears: 10, isNocturnal: true, nativeRegion: "Mondial sauf Antarctique", funFact: "L'effraie des clochers possède une ouïe si fine qu'elle peut capturer une proie dans l'obscurité totale.", tags: ["nocturne", "rapace"] },
    { name: "Loup gris", scientificName: "Canis lupus", type: "mammal", habitat: "forest", diet: "carnivore", conservationStatus: "LC", weightKg: 45, lifespanYears: 13, isNocturnal: true, nativeRegion: "Europe, Asie, Amérique du Nord", funFact: "Le loup gris communique par des hurlements audibles jusqu'à 16 km en terrain dégagé.", speed: 60, tags: ["meute", "prédateur"] },
    { name: "Sanglier", scientificName: "Sus scrofa", type: "mammal", habitat: "forest", diet: "omnivore", conservationStatus: "LC", weightKg: 80, lifespanYears: 20, isNocturnal: true, nativeRegion: "Europe, Asie", funFact: "Le sanglier peut courir à 40 km/h et nager sur de longues distances.", speed: 40, tags: ["robuste", "adaptable"] },
    { name: "Flamant rose", scientificName: "Phoenicopterus roseus", type: "bird", habitat: "wetland", diet: "omnivore", conservationStatus: "LC", weightKg: 3.5, lifespanYears: 40, isNocturnal: false, nativeRegion: "Méditerranée, Afrique", funFact: "La couleur rose des flamants provient des caroténoïdes contenus dans les crevettes et algues qu'ils mangent.", tags: ["Camargue", "coloré"] },
    { name: "Blaireau européen", scientificName: "Meles meles", type: "mammal", habitat: "forest", diet: "omnivore", conservationStatus: "LC", weightKg: 12, lifespanYears: 15, isNocturnal: true, nativeRegion: "Europe", funFact: "Le blaireau européen construit des terriers complexes appelés 'blaireautières' qui peuvent avoir des siècles d'âge.", tags: ["nocturne", "fouisseur"] },
    { name: "Tortue caouanne", scientificName: "Caretta caretta", type: "reptile", habitat: "ocean", diet: "omnivore", conservationStatus: "VU", weightKg: 135, lifespanYears: 65, isNocturnal: false, nativeRegion: "Océans tropicaux et subtropicaux", funFact: "La tortue caouanne migre sur plus de 12 000 km et revient pondre sur la plage exacte où elle est née.", tags: ["migration", "marin"] },
    { name: "Lièvre d'Europe", scientificName: "Lepus europaeus", type: "mammal", habitat: "grassland", diet: "herbivore", conservationStatus: "LC", weightKg: 4, lifespanYears: 12, isNocturnal: true, nativeRegion: "Europe", funFact: "Le lièvre d'Europe peut atteindre 70 km/h en course et faire des bonds de 3 mètres de haut.", speed: 70, tags: ["rapide", "campagne"] },
    { name: "Huppe fasciée", scientificName: "Upupa epops", type: "bird", habitat: "grassland", diet: "insectivore", conservationStatus: "LC", weightKg: 0.07, lifespanYears: 10, isNocturnal: false, nativeRegion: "Europe, Asie, Afrique", funFact: "La huppe fasciée sécrète une huile nauséabonde pour repousser les prédateurs de son nid.", tags: ["crête", "migrateur"] },
  ],
  es: [
    { name: "Lince ibérico", scientificName: "Lynx pardinus", type: "mammal", habitat: "forest", diet: "carnivore", conservationStatus: "EN", weightKg: 13, lifespanYears: 13, isNocturnal: true, nativeRegion: "Península Ibérica", funFact: "El lince ibérico es el felino más amenazado del mundo — en 2002 solo quedaban 94 ejemplares.", speed: 60, tags: ["endémico", "amenazado"] },
    { name: "Águila imperial ibérica", scientificName: "Aquila adalberti", type: "bird", habitat: "forest", diet: "carnivore", conservationStatus: "VU", weightKg: 3.5, lifespanYears: 20, isNocturnal: false, nativeRegion: "España, Portugal", funFact: "El águila imperial ibérica forma parejas de por vida y reutiliza el mismo nido año tras año.", speed: 80, tags: ["rapaz", "ibérica"] },
    { name: "Lobo ibérico", scientificName: "Canis lupus signatus", type: "mammal", habitat: "forest", diet: "carnivore", conservationStatus: "VU", weightKg: 40, lifespanYears: 12, isNocturnal: true, nativeRegion: "Norte de España, Portugal", funFact: "El lobo ibérico tiene unas marcas faciales únicas que lo distinguen de otras subespecies europeas.", speed: 55, tags: ["manada", "ibérico"] },
    { name: "Conejo europeo", scientificName: "Oryctolagus cuniculus", type: "mammal", habitat: "grassland", diet: "herbivore", conservationStatus: "EN", weightKg: 2, lifespanYears: 9, isNocturnal: true, nativeRegion: "Península Ibérica", funFact: "El conejo europeo es originario de la Península Ibérica — el nombre 'España' podría derivar del fenicio 'tierra de conejos'.", tags: ["endémico", "presa clave"] },
    { name: "Oso pardo cantábrico", scientificName: "Ursus arctos", type: "mammal", habitat: "mountain", diet: "omnivore", conservationStatus: "EN", weightKg: 180, lifespanYears: 30, isNocturnal: true, nativeRegion: "Cordillera Cantábrica, España", funFact: "El oso pardo cantábrico pasó de 70 ejemplares en los años 90 a más de 370 gracias a programas de conservación.", tags: ["conservación", "montaña"] },
    { name: "Jaguar", scientificName: "Panthera onca", type: "mammal", habitat: "forest", diet: "carnivore", conservationStatus: "NT", weightKg: 100, lifespanYears: 15, isNocturnal: true, nativeRegion: "América Central y del Sur", funFact: "El jaguar tiene la mordida más fuerte de todos los grandes felinos y puede perforar el caparazón de una tortuga.", speed: 80, tags: ["gran felino", "americano"] },
    { name: "Cóndor andino", scientificName: "Vultur gryphus", type: "bird", habitat: "mountain", diet: "carnivore", conservationStatus: "VU", weightKg: 12, lifespanYears: 70, isNocturnal: false, nativeRegion: "Cordillera de los Andes", funFact: "El cóndor andino tiene una envergadura de 3,2 metros y puede planear a más de 5 000 metros de altitud sin batir las alas.", speed: 55, tags: ["carroñero", "andino"] },
    { name: "Oso hormiguero gigante", scientificName: "Myrmecophaga tridactyla", type: "mammal", habitat: "grassland", diet: "insectivore", conservationStatus: "VU", weightKg: 40, lifespanYears: 16, isNocturnal: false, nativeRegion: "América Central y del Sur", funFact: "El oso hormiguero puede comer hasta 35 000 hormigas al día con su lengua de 60 cm.", tags: ["insectívoro", "sudamericano"] },
    { name: "Capibara", scientificName: "Hydrochoerus hydrochaeris", type: "mammal", habitat: "wetland", diet: "herbivore", conservationStatus: "LC", weightKg: 55, lifespanYears: 10, isNocturnal: false, nativeRegion: "América del Sur", funFact: "La capibara es el roedor más grande del mundo y es tan social que otros animales se sientan sobre ella.", speed: 35, tags: ["roedor", "social"] },
    { name: "Iguana verde", scientificName: "Iguana iguana", type: "reptile", habitat: "forest", diet: "herbivore", conservationStatus: "LC", weightKg: 5, lifespanYears: 20, isNocturnal: false, nativeRegion: "América Central y del Sur", funFact: "La iguana verde puede caer de 15 metros de altura y sobrevivir sin lesiones.", tags: ["reptil", "tropical"] },
    { name: "Piquero de patas azules", scientificName: "Sula nebouxii", type: "bird", habitat: "ocean", diet: "piscivore", conservationStatus: "LC", weightKg: 1.5, lifespanYears: 17, isNocturnal: false, nativeRegion: "Islas Galápagos, Pacífico", funFact: "El piquero de patas azules atrae a su pareja bailando y mostrando sus patas — cuanto más azules, más atractivo.", tags: ["Galápagos", "cortejo"] },
    { name: "Rana dardo venenosa", scientificName: "Dendrobates tinctorius", type: "amphibian", habitat: "forest", diet: "insectivore", conservationStatus: "LC", weightKg: 0.003, lifespanYears: 8, isNocturnal: false, nativeRegion: "América del Sur", funFact: "La rana dardo dorada tiene suficiente veneno para matar a 10 personas — las tribus indígenas lo usan en sus flechas.", tags: ["venenoso", "colorido"] },
    { name: "Oso de anteojos", scientificName: "Tremarctos ornatus", type: "mammal", habitat: "mountain", diet: "omnivore", conservationStatus: "VU", weightKg: 140, lifespanYears: 25, isNocturnal: true, nativeRegion: "Andes sudamericanos", funFact: "El oso de anteojos es el único oso de América del Sur y el último oso de cara corta del mundo.", tags: ["andino", "único"] },
    { name: "Ocelote", scientificName: "Leopardus pardalis", type: "mammal", habitat: "forest", diet: "carnivore", conservationStatus: "LC", weightKg: 12, lifespanYears: 15, isNocturnal: true, nativeRegion: "América Central y del Sur", funFact: "Salvador Dalí tenía un ocelote como mascota llamado Babou y lo llevaba a todas partes.", speed: 61, tags: ["felino", "nocturno"] },
    { name: "Quetzal resplandeciente", scientificName: "Pharomachrus mocinno", type: "bird", habitat: "forest", diet: "omnivore", conservationStatus: "NT", weightKg: 0.2, lifespanYears: 20, isNocturnal: false, nativeRegion: "América Central", funFact: "El quetzal era sagrado para los mayas y aztecas — su nombre da origen a la moneda de Guatemala.", tags: ["sagrado", "plumaje"] },
    { name: "Tapir centroamericano", scientificName: "Tapirus bairdii", type: "mammal", habitat: "forest", diet: "herbivore", conservationStatus: "EN", weightKg: 300, lifespanYears: 30, isNocturnal: true, nativeRegion: "América Central", funFact: "El tapir centroamericano es considerado un 'fósil viviente' — su forma apenas ha cambiado en 20 millones de años.", tags: ["primitivo", "amenazado"] },
    { name: "Piraña roja", scientificName: "Pygocentrus nattereri", type: "fish", habitat: "freshwater", diet: "carnivore", conservationStatus: "LC", weightKg: 1, lifespanYears: 10, isNocturnal: false, nativeRegion: "Ríos de América del Sur", funFact: "Las pirañas ladran como perros cuando se sienten amenazadas — es una forma de comunicación acústica.", tags: ["depredador", "amazónico"] },
    { name: "Boto rosado", scientificName: "Inia geoffrensis", type: "mammal", habitat: "freshwater", diet: "piscivore", conservationStatus: "EN", weightKg: 185, lifespanYears: 30, isNocturnal: false, nativeRegion: "Amazonia", funFact: "El boto rosado se vuelve más rosa con la edad y el esfuerzo físico — los machos luchan para impresionar a las hembras.", tags: ["delfín", "amazónico"] },
    { name: "Caimán de anteojos", scientificName: "Caiman crocodilus", type: "reptile", habitat: "wetland", diet: "carnivore", conservationStatus: "LC", weightKg: 40, lifespanYears: 40, isNocturnal: true, nativeRegion: "América Central y del Sur", funFact: "El caimán de anteojos debe su nombre a la cresta ósea entre sus ojos que parece unas gafas.", tags: ["reptil", "acuático"] },
    { name: "Tortuga gigante de Galápagos", scientificName: "Chelonoidis niger", type: "reptile", habitat: "grassland", diet: "herbivore", conservationStatus: "VU", weightKg: 250, lifespanYears: 175, isNocturnal: false, nativeRegion: "Islas Galápagos", funFact: "La tortuga gigante de Galápagos inspiró la teoría de la evolución de Darwin — 'Lonesome George' fue el último de su subespecie.", tags: ["longevidad", "Galápagos"] },
  ],
  sr: [
    { name: "Мрки медвед", scientificName: "Ursus arctos", type: "mammal", habitat: "forest", diet: "omnivore", conservationStatus: "LC", weightKg: 250, lifespanYears: 30, isNocturnal: true, nativeRegion: "Динарске планине, Србија", funFact: "У Србији живи око 80 мрких медведа, углавном на планинама Тара и Златибор.", speed: 50, tags: ["велики сисар", "заштићен"] },
    { name: "Сиви вук", scientificName: "Canis lupus", type: "mammal", habitat: "forest", diet: "carnivore", conservationStatus: "LC", weightKg: 40, lifespanYears: 13, isNocturnal: true, nativeRegion: "Европа, Азија", funFact: "У Србији живи око 800 вукова — једна од највећих популација у Европи.", speed: 60, tags: ["чопор", "предатор"] },
    { name: "Балкански рис", scientificName: "Lynx lynx balcanicus", type: "mammal", habitat: "forest", diet: "carnivore", conservationStatus: "CR", weightKg: 22, lifespanYears: 15, isNocturnal: true, nativeRegion: "Балканско полуострво", funFact: "Балкански рис је најугроженија подврста евроазијског риса — процењује се да их има мање од 50.", speed: 55, tags: ["критично угрожен", "мачка"] },
    { name: "Дивља свиња", scientificName: "Sus scrofa", type: "mammal", habitat: "forest", diet: "omnivore", conservationStatus: "LC", weightKg: 90, lifespanYears: 20, isNocturnal: true, nativeRegion: "Европа, Азија", funFact: "Дивље свиње имају одличан њух — могу да осете храну закопану 30 цм испод земље.", speed: 40, tags: ["робустан", "свеједар"] },
    { name: "Срна", scientificName: "Capreolus capreolus", type: "mammal", habitat: "forest", diet: "herbivore", conservationStatus: "LC", weightKg: 25, lifespanYears: 12, isNocturnal: false, nativeRegion: "Европа, Мала Азија", funFact: "Срна може да скочи преко 2 метра у вис и трчи брзином до 65 км/ч.", speed: 65, tags: ["грациозна", "шумска"] },
    { name: "Јелен обични", scientificName: "Cervus elaphus", type: "mammal", habitat: "forest", diet: "herbivore", conservationStatus: "LC", weightKg: 200, lifespanYears: 20, isNocturnal: false, nativeRegion: "Европа, Азија", funFact: "Рогови јелена расту до 2,5 цм дневно — то је један од најбржих растова ткива у животињском свету.", tags: ["величанствен", "рогови"] },
    { name: "Златни шакал", scientificName: "Canis aureus", type: "mammal", habitat: "grassland", diet: "omnivore", conservationStatus: "LC", weightKg: 10, lifespanYears: 8, isNocturnal: true, nativeRegion: "Балкан, Мала Азија", funFact: "Шакал се проширио по целом Балкану и све чешће се среће и у централној Европи.", speed: 40, tags: ["опортунист", "адаптабилан"] },
    { name: "Поскок", scientificName: "Vipera ammodytes", type: "reptile", habitat: "mountain", diet: "carnivore", conservationStatus: "LC", weightKg: 0.2, lifespanYears: 20, isNocturnal: false, nativeRegion: "Балканско полуострво", funFact: "Поскок је најотровнија европска змија — препознатљив по рошчићу на врху губице.", tags: ["отровна", "балканска"] },
    { name: "Далматински пеликан", scientificName: "Pelecanus crispus", type: "bird", habitat: "wetland", diet: "piscivore", conservationStatus: "NT", weightKg: 12, lifespanYears: 35, isNocturnal: false, nativeRegion: "Југоисточна Европа", funFact: "Далматински пеликан је најтежа летећа птица на свету — може тежити и до 15 кг.", speed: 65, tags: ["највећи", "мочварни"] },
    { name: "Белорепан", scientificName: "Haliaeetus albicilla", type: "bird", habitat: "freshwater", diet: "piscivore", conservationStatus: "LC", weightKg: 6, lifespanYears: 25, isNocturnal: false, nativeRegion: "Европа", funFact: "Белорепан има распон крила до 2,4 метра и гнездо тешко до тону.", speed: 70, tags: ["орао", "рибар"] },
    { name: "Барска корњача", scientificName: "Emys orbicularis", type: "reptile", habitat: "freshwater", diet: "omnivore", conservationStatus: "NT", weightKg: 0.7, lifespanYears: 50, isNocturnal: false, nativeRegion: "Европа, Северна Африка", funFact: "Барска корњача може провести целу зиму закопана у муљу на дну бара.", tags: ["акватична", "дуговечна"] },
    { name: "Црна рода", scientificName: "Ciconia nigra", type: "bird", habitat: "forest", diet: "piscivore", conservationStatus: "LC", weightKg: 3, lifespanYears: 18, isNocturnal: false, nativeRegion: "Европа, Азија", funFact: "За разлику од беле роде, црна рода избегава људе и гнезди се дубоко у шумама.", speed: 45, tags: ["плашљива", "миграторна"] },
    { name: "Видра", scientificName: "Lutra lutra", type: "mammal", habitat: "freshwater", diet: "piscivore", conservationStatus: "NT", weightKg: 10, lifespanYears: 12, isNocturnal: true, nativeRegion: "Европа", funFact: "Видра може да затвори уши и ноздрве под водом и зарони до 8 минута.", speed: 12, tags: ["акватична", "разиграна"] },
    { name: "Дивокоза", scientificName: "Rupicapra rupicapra", type: "mammal", habitat: "mountain", diet: "herbivore", conservationStatus: "LC", weightKg: 35, lifespanYears: 22, isNocturnal: false, nativeRegion: "Планине Европе", funFact: "Дивокоза може да скочи 6 метара у даљину и пење се по стрмим литицама.", speed: 50, tags: ["планинска", "агилна"] },
    { name: "Европски бизон", scientificName: "Bison bonasus", type: "mammal", habitat: "forest", diet: "herbivore", conservationStatus: "VU", weightKg: 800, lifespanYears: 25, isNocturnal: false, nativeRegion: "Источна Европа", funFact: "Европски бизон је замало изумро — 1927. године остало је само 54 примерка у заробљеништву.", tags: ["мегафауна", "конзервација"] },
    { name: "Степски соко", scientificName: "Falco cherrug", type: "bird", habitat: "grassland", diet: "carnivore", conservationStatus: "EN", weightKg: 1.1, lifespanYears: 15, isNocturnal: false, nativeRegion: "Источна Европа, Азија", funFact: "Степски соко лови у стрмоглавом лету брзином до 200 км/ч.", speed: 200, tags: ["грабљивица", "брзина"] },
    { name: "Буљина", scientificName: "Bubo bubo", type: "bird", habitat: "mountain", diet: "carnivore", conservationStatus: "LC", weightKg: 3, lifespanYears: 20, isNocturnal: true, nativeRegion: "Европа, Азија", funFact: "Буљина је највећа европска сова — распон крила достиже 1,8 метара.", tags: ["ноћна", "велика сова"] },
    { name: "Водоземац обични мрмољак", scientificName: "Ichthyosaura alpestris", type: "amphibian", habitat: "freshwater", diet: "carnivore", conservationStatus: "LC", weightKg: 0.01, lifespanYears: 10, isNocturnal: true, nativeRegion: "Европа", funFact: "Планински мрмољак има блиставо наранџасти стомак који служи као упозорење предаторима.", tags: ["водоземац", "шарен"] },
    { name: "Каменарка", scientificName: "Martes foina", type: "mammal", habitat: "urban", diet: "omnivore", conservationStatus: "LC", weightKg: 1.8, lifespanYears: 10, isNocturnal: true, nativeRegion: "Европа, Азија", funFact: "Каменарка је позната по томе што гризе каблове аутомобила — у Германији узрокује штете од милионе евра годишње.", speed: 30, tags: ["урбана", "опортунист"] },
    { name: "Лос", scientificName: "Alces alces", type: "mammal", habitat: "forest", diet: "herbivore", conservationStatus: "LC", weightKg: 500, lifespanYears: 20, isNocturnal: false, nativeRegion: "Северна Европа, Сибир", funFact: "Лос може да зарони до 6 метара дубоко да би јео водене биљке.", speed: 56, tags: ["највећи јелен", "пливач"] },
  ],
  de: [
    { name: "Europäischer Dachs", scientificName: "Meles meles", type: "mammal", habitat: "forest", diet: "omnivore", conservationStatus: "LC", weightKg: 12, lifespanYears: 15, isNocturnal: true, nativeRegion: "Europa", funFact: "Dachsbaue können über Jahrhunderte bestehen und bis zu 50 Eingänge haben.", tags: ["nachtaktiv", "Grabungstier"] },
    { name: "Eichhörnchen", scientificName: "Sciurus vulgaris", type: "mammal", habitat: "forest", diet: "omnivore", conservationStatus: "LC", weightKg: 0.3, lifespanYears: 7, isNocturnal: false, nativeRegion: "Europa, Nordasien", funFact: "Eichhörnchen vergessen etwa 74 % ihrer vergrabenen Nüsse — und pflanzen so unbeabsichtigt Bäume.", speed: 25, tags: ["flink", "Wald"] },
    { name: "Igel", scientificName: "Erinaceus europaeus", type: "mammal", habitat: "forest", diet: "omnivore", conservationStatus: "LC", weightKg: 1.2, lifespanYears: 7, isNocturnal: true, nativeRegion: "Westeuropa", funFact: "Igel haben bis zu 8.000 Stacheln und sind teilweise immun gegen Schlangengift.", tags: ["nachtaktiv", "Garten"] },
    { name: "Eichelhäher", scientificName: "Garrulus glandarius", type: "bird", habitat: "forest", diet: "omnivore", conservationStatus: "LC", weightKg: 0.17, lifespanYears: 17, isNocturnal: false, nativeRegion: "Europa, Asien", funFact: "Eichelhäher können die Rufe anderer Vögel und sogar Kettensägen imitieren.", tags: ["intelligent", "laut"] },
    { name: "Feuersalamander", scientificName: "Salamandra salamandra", type: "amphibian", habitat: "forest", diet: "insectivore", conservationStatus: "LC", weightKg: 0.04, lifespanYears: 20, isNocturnal: true, nativeRegion: "Mittel- und Südeuropa", funFact: "Im Mittelalter glaubte man, Feuersalamander seien feuerfest — daher ihr Name.", tags: ["giftig", "auffällig"] },
    { name: "Hirschkäfer", scientificName: "Lucanus cervus", type: "insect", habitat: "forest", diet: "herbivore", conservationStatus: "NT", weightKg: 0.007, lifespanYears: 0.5, isNocturnal: true, nativeRegion: "Europa", funFact: "Der Hirschkäfer ist Europas größter Käfer — die Männchen nutzen ihre riesigen Mandibeln für Ringkämpfe.", tags: ["geschützt", "selten"] },
    { name: "Bienenfresser", scientificName: "Merops apiaster", type: "bird", habitat: "grassland", diet: "insectivore", conservationStatus: "LC", weightKg: 0.06, lifespanYears: 6, isNocturnal: false, nativeRegion: "Südeuropa, Mittlerer Osten", funFact: "Bienenfresser entfernen den Giftstachel einer Biene, indem sie sie gegen einen Ast schlagen.", tags: ["farbenfroh", "Zugvogel"] },
    { name: "Kranich", scientificName: "Grus grus", type: "bird", habitat: "wetland", diet: "omnivore", conservationStatus: "LC", weightKg: 6, lifespanYears: 30, isNocturnal: false, nativeRegion: "Nordeuropa, Sibirien", funFact: "Über 250.000 Kraniche rasten jährlich am Bodden in Mecklenburg-Vorpommern auf ihrem Weg nach Süden.", speed: 65, tags: ["Zugvogel", "majestätisch"] },
    { name: "Weißstorch", scientificName: "Ciconia ciconia", type: "bird", habitat: "wetland", diet: "carnivore", conservationStatus: "LC", weightKg: 3.5, lifespanYears: 25, isNocturnal: false, nativeRegion: "Europa, Nordafrika", funFact: "In Deutschland gelten Störche als Glücksbringer — Storchennester auf Hausdächern sind seit Jahrhunderten willkommen.", speed: 45, tags: ["Kulturfolger", "Glücksbringer"] },
    { name: "Europäischer Nerz", scientificName: "Mustela lutreola", type: "mammal", habitat: "freshwater", diet: "carnivore", conservationStatus: "CR", weightKg: 0.7, lifespanYears: 7, isNocturnal: true, nativeRegion: "Europa", funFact: "Der Europäische Nerz ist eines der am stärksten bedrohten Säugetiere Europas — weniger als 1.000 leben in freier Wildbahn.", tags: ["kritisch bedroht", "aquatisch"] },
    { name: "Rotmilan", scientificName: "Milvus milvus", type: "bird", habitat: "grassland", diet: "carnivore", conservationStatus: "NT", weightKg: 1.2, lifespanYears: 26, isNocturnal: false, nativeRegion: "Europa", funFact: "Deutschland beherbergt über 50 % der Weltpopulation des Rotmilans — er ist Deutschlands heimlicher Wappenvogel.", speed: 60, tags: ["Greifvogel", "deutsch"] },
    { name: "Alpensalamander", scientificName: "Salamandra atra", type: "amphibian", habitat: "mountain", diet: "insectivore", conservationStatus: "LC", weightKg: 0.01, lifespanYears: 15, isNocturnal: true, nativeRegion: "Alpen", funFact: "Der Alpensalamander ist eines der wenigen Amphibien, das lebende Junge gebiert statt Eier zu legen.", tags: ["alpin", "lebendgebärend"] },
    { name: "Europäische Wildkatze", scientificName: "Felis silvestris", type: "mammal", habitat: "forest", diet: "carnivore", conservationStatus: "LC", weightKg: 5, lifespanYears: 15, isNocturnal: true, nativeRegion: "Europa", funFact: "Die Europäische Wildkatze sieht einer Hauskatze ähnlich, ist aber deutlich scheuer und kräftiger gebaut.", speed: 50, tags: ["scheu", "Waldkatze"] },
    { name: "Auerhuhn", scientificName: "Tetrao urogallus", type: "bird", habitat: "forest", diet: "herbivore", conservationStatus: "LC", weightKg: 4, lifespanYears: 10, isNocturnal: false, nativeRegion: "Nordeuropa, Alpen", funFact: "Während der Balz wird das Auerhuhn-Männchen so taub, dass man sich ihm unbemerkt nähern kann.", tags: ["Balz", "Waldvogel"] },
    { name: "Tannenhäher", scientificName: "Nucifraga caryocatactes", type: "bird", habitat: "mountain", diet: "omnivore", conservationStatus: "LC", weightKg: 0.18, lifespanYears: 10, isNocturnal: false, nativeRegion: "Alpen, Nordeuropa", funFact: "Der Tannenhäher vergräbt bis zu 100.000 Arvennüsse pro Herbst und findet die meisten davon unter dem Schnee wieder.", tags: ["Vorratshaltung", "Bergwald"] },
    { name: "Iltis", scientificName: "Mustela putorius", type: "mammal", habitat: "forest", diet: "carnivore", conservationStatus: "LC", weightKg: 1.2, lifespanYears: 8, isNocturnal: true, nativeRegion: "Europa", funFact: "Der Iltis ist der wilde Vorfahre des Frettchens — er wurde vor über 2.500 Jahren domestiziert.", tags: ["nachtaktiv", "Marder"] },
    { name: "Schwarzspecht", scientificName: "Dryocopus martius", type: "bird", habitat: "forest", diet: "insectivore", conservationStatus: "LC", weightKg: 0.3, lifespanYears: 11, isNocturnal: false, nativeRegion: "Europa, Nordasien", funFact: "Der Schwarzspecht hämmert bis zu 20 Mal pro Sekunde auf Holz — sein Schädel ist stoßdämpfend konstruiert.", tags: ["Zimmermann", "laut"] },
    { name: "Steinbock", scientificName: "Capra ibex", type: "mammal", habitat: "mountain", diet: "herbivore", conservationStatus: "LC", weightKg: 100, lifespanYears: 20, isNocturnal: false, nativeRegion: "Alpen", funFact: "Steinböcke können fast senkrechte Felswände erklimmen — ihre Hufe wirken wie natürliche Kletterschuhe.", speed: 30, tags: ["alpin", "Kletterer"] },
    { name: "Feldhase", scientificName: "Lepus europaeus", type: "mammal", habitat: "grassland", diet: "herbivore", conservationStatus: "LC", weightKg: 4, lifespanYears: 12, isNocturnal: true, nativeRegion: "Europa", funFact: "Feldhasen können bis zu 70 km/h schnell laufen und 3 Meter hoch springen.", speed: 70, tags: ["schnell", "Ostersymbol"] },
    { name: "Luchs", scientificName: "Lynx lynx", type: "mammal", habitat: "forest", diet: "carnivore", conservationStatus: "LC", weightKg: 25, lifespanYears: 17, isNocturnal: true, nativeRegion: "Europa, Sibirien", funFact: "Im Harz wurde der Luchs 2000 erfolgreich wiederangesiedelt — heute leben dort wieder über 90 Tiere.", speed: 60, tags: ["Pinselohren", "Wiederansiedlung"] },
  ],
  mk: [
    { name: "Балкански рис", scientificName: "Lynx lynx balcanicus", type: "mammal", habitat: "forest", diet: "carnivore", conservationStatus: "CR", weightKg: 22, lifespanYears: 15, isNocturnal: true, nativeRegion: "Балканско Полуострво", funFact: "Балканскиот рис е симбол на македонската дивина — се проценува дека останале помалку од 50 единки.", speed: 55, tags: ["критично загрозен", "симбол"] },
    { name: "Сив волк", scientificName: "Canis lupus", type: "mammal", habitat: "forest", diet: "carnivore", conservationStatus: "LC", weightKg: 40, lifespanYears: 13, isNocturnal: true, nativeRegion: "Европа, Азија", funFact: "Волците во Македонија живеат во планините Шар Планина и Маврово — нивното завивање може да се слушне на 16 км.", speed: 60, tags: ["предатор", "чопор"] },
    { name: "Мрки медвед", scientificName: "Ursus arctos", type: "mammal", habitat: "forest", diet: "omnivore", conservationStatus: "LC", weightKg: 250, lifespanYears: 30, isNocturnal: true, nativeRegion: "Европа, Азија", funFact: "Во Националниот парк Маврово живеат околу 80-100 мрки медведи.", speed: 50, tags: ["голем цицач", "заштитен"] },
    { name: "Дива свиња", scientificName: "Sus scrofa", type: "mammal", habitat: "forest", diet: "omnivore", conservationStatus: "LC", weightKg: 90, lifespanYears: 20, isNocturnal: true, nativeRegion: "Европа, Азија", funFact: "Дивата свиња има извонреден мирис — може да најде храна закопана 30 цм под земја.", speed: 40, tags: ["сештојадец", "приспособлив"] },
    { name: "Белоглав мршојадец", scientificName: "Gyps fulvus", type: "bird", habitat: "mountain", diet: "carnivore", conservationStatus: "LC", weightKg: 10, lifespanYears: 35, isNocturnal: false, nativeRegion: "Балкан, Медитеран", funFact: "Белоглавиот мршојадец може да лета на висина над 11.000 метри и да лоцира мрша од неколку километри.", speed: 120, tags: ["мршојадец", "импресивен"] },
    { name: "Далматински пеликан", scientificName: "Pelecanus crispus", type: "bird", habitat: "wetland", diet: "piscivore", conservationStatus: "NT", weightKg: 12, lifespanYears: 35, isNocturnal: false, nativeRegion: "Југоисточна Европа", funFact: "Преспанското Езеро е едно од најважните места за гнездење на далматинскиот пеликан во светот.", speed: 65, tags: ["ендемичен", "Преспа"] },
    { name: "Охридска пастрмка", scientificName: "Salmo letnica", type: "fish", habitat: "freshwater", diet: "carnivore", conservationStatus: "CR", weightKg: 3, lifespanYears: 10, isNocturnal: false, nativeRegion: "Охридско Езеро", funFact: "Охридската пастрмка е ендемичен вид стар над 2 милиони години — живее само во Охридското Езеро.", tags: ["ендемичен", "Охрид"] },
    { name: "Барска желка", scientificName: "Emys orbicularis", type: "reptile", habitat: "freshwater", diet: "omnivore", conservationStatus: "NT", weightKg: 0.7, lifespanYears: 50, isNocturnal: false, nativeRegion: "Европа", funFact: "Барската желка може да ја помине целата зима закопана во калта на дното од барата.", tags: ["долговечна", "акватична"] },
    { name: "Камена куна", scientificName: "Martes foina", type: "mammal", habitat: "urban", diet: "omnivore", conservationStatus: "LC", weightKg: 1.8, lifespanYears: 10, isNocturnal: true, nativeRegion: "Европа, Азија", funFact: "Камената куна е позната по тоа што гризе кабли од автомобили — причинува штети од милиони евра годишно.", speed: 30, tags: ["урбана", "опортунист"] },
    { name: "Змија поскок", scientificName: "Vipera ammodytes", type: "reptile", habitat: "mountain", diet: "carnivore", conservationStatus: "LC", weightKg: 0.2, lifespanYears: 20, isNocturnal: false, nativeRegion: "Балканско Полуострво", funFact: "Поскокот е најотровната европска змија — препознатлив по рогчето на врвот на носот.", tags: ["отровна", "балканска"] },
    { name: "Срна", scientificName: "Capreolus capreolus", type: "mammal", habitat: "forest", diet: "herbivore", conservationStatus: "LC", weightKg: 25, lifespanYears: 12, isNocturnal: false, nativeRegion: "Европа", funFact: "Срната може да скокне повеќе од 2 метри висина и да трча со брзина до 65 км/ч.", speed: 65, tags: ["грациозна", "шумска"] },
    { name: "Обичен мишелов", scientificName: "Falco tinnunculus", type: "bird", habitat: "grassland", diet: "carnivore", conservationStatus: "LC", weightKg: 0.2, lifespanYears: 15, isNocturnal: false, nativeRegion: "Европа, Азија, Африка", funFact: "Мишеловот може да лебди во воздухот на едно место додека лови — како хеликоптер.", speed: 60, tags: ["грабливка", "лебдење"] },
    { name: "Шумски був", scientificName: "Bubo bubo", type: "bird", habitat: "mountain", diet: "carnivore", conservationStatus: "LC", weightKg: 3, lifespanYears: 20, isNocturnal: true, nativeRegion: "Европа, Азија", funFact: "Шумскиот був е најголемата европска сова — распонот на крилата достигнува 1,8 метри.", tags: ["ноќна", "голема сова"] },
    { name: "Видра", scientificName: "Lutra lutra", type: "mammal", habitat: "freshwater", diet: "piscivore", conservationStatus: "NT", weightKg: 10, lifespanYears: 12, isNocturnal: true, nativeRegion: "Европа", funFact: "Видрата може да ги затвори ушите и ноздрите под вода и да зарони до 8 минути.", speed: 12, tags: ["акватична", "разиграна"] },
    { name: "Златен орел", scientificName: "Aquila chrysaetos", type: "bird", habitat: "mountain", diet: "carnivore", conservationStatus: "LC", weightKg: 5, lifespanYears: 30, isNocturnal: false, nativeRegion: "Европа, Азија, Северна Америка", funFact: "Златниот орел може да забележи зајак од висина од 3 километри.", speed: 320, tags: ["кралски", "грабливец"] },
    { name: "Дивокоза", scientificName: "Rupicapra rupicapra", type: "mammal", habitat: "mountain", diet: "herbivore", conservationStatus: "LC", weightKg: 35, lifespanYears: 22, isNocturnal: false, nativeRegion: "Планини на Европа", funFact: "Дивокозата може да скокне 6 метри во далечина и да се качува по стрмни карпи.", speed: 50, tags: ["планинска", "агилна"] },
    { name: "Европски бизон", scientificName: "Bison bonasus", type: "mammal", habitat: "forest", diet: "herbivore", conservationStatus: "VU", weightKg: 800, lifespanYears: 25, isNocturnal: false, nativeRegion: "Источна Европа", funFact: "Европскиот бизон замалку не изумрел — во 1927 останале само 54 примероци во заробеништво.", tags: ["мегафауна", "конзервација"] },
    { name: "Планински мрморец", scientificName: "Ichthyosaura alpestris", type: "amphibian", habitat: "freshwater", diet: "carnivore", conservationStatus: "LC", weightKg: 0.01, lifespanYears: 10, isNocturnal: true, nativeRegion: "Европа", funFact: "Планинскиот мрморец има портокалов стомак кој служи како предупредување за предаторите.", tags: ["водоземец", "шарен"] },
    { name: "Левантски јастреб", scientificName: "Accipiter brevipes", type: "bird", habitat: "forest", diet: "carnivore", conservationStatus: "LC", weightKg: 0.25, lifespanYears: 12, isNocturnal: false, nativeRegion: "Балкан, Мала Азија", funFact: "Левантскиот јастреб е специјалист за ловење гуштери и големи инсекти во лет.", speed: 50, tags: ["грабливка", "балканска"] },
    { name: "Европска ролна", scientificName: "Coracias garrulus", type: "bird", habitat: "grassland", diet: "insectivore", conservationStatus: "LC", weightKg: 0.15, lifespanYears: 9, isNocturnal: false, nativeRegion: "Европа, Централна Азија", funFact: "Европската ролна е најшарената европска птица — при бранење на територијата, се превртува во воздухот.", tags: ["шарена", "акробатска"] },
  ],
}
...
async function main() {
  ...
  for (const [locale, adminId] of Object.entries(localeAdmins)) {
    if (!adminId) continue
    await seedTable("animals", locale, adminId, animals[locale] ?? [])
  }
